import { Team, DefensiveScheme, DefensiveAssignments, Assignment, Formation, Position, Id } from '@basketball-sim/types';
...
export class DefensiveCoordinator {
  ...
  getMatchup(offensivePlayer: Id, assignments: DefensiveAssignments): Id | null {
    const assignment = assignments.assignments.find(a => 
      a.type === 'man' && a.target === offensivePlayer
    );
  ...
  private createManToManAssignments(
    offense: Team,
    defense: Team,
    formation: Formation
  ): Assignment[] {
  ...
  private createSwitchingAssignments(
    offense: Team,
    defense: Team,
    formation: Formation
  ): Assignment[] {
  ...
  private createFullCourtAssignments(
    offense: Team,
    defense: Team,
    formation: Formation
  ): Assignment[] {
  ...
  private findSecondClosestDefender(
    target: Id,
    defense: Team,
    formation: Formation,
    excluding: Id
